...
class CalorieTracker {
    ...
    _displayCaloriesBurned(){
        const _caloriesBurnedEl = document.getElementById('calories-burned'); 
        const burned = this._workouts.reduce((total, workout) => total + workout.calories, 0);

        _caloriesBurnedEl.innerHTML = burned
    }

    _displayCaloriesConsumed(){
        const _caloriesConsumedEl = document.getElementById('calories-consumed'); 
        const consumed = this._meals.reduce((total, meal) => total + meal.calories, 0);

        _caloriesConsumedEl.innerHTML = consumed
    }
